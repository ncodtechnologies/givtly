  ...
  render() {
    ...
    return (
     ...
     <View>
      ...
      renderRow={data =>
        <TouchableOpacity
         onPress={()=> this.props.navigation.navigate("SubCategoryList", { id_category: data._id, category: data.category, section: this.state.section, section_img : this.state.section_img  })}
         style={{ height: 50 }}
          >
